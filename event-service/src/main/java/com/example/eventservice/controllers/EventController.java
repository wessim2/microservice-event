...
public class EventController {
    ...
    public ResponseEntity<Void> linkOrganizerToEvents(@PathVariable Long id, @RequestBody List<Long> organizerIds) {
        _eventService.linkEventToOrganizers(id, organizerIds);
